import { Inbox, Star, Archive, Search, LogOut, SlidersHorizontal, Send, FileEdit, SquarePen } from "lucide-react";
...
export default function Sidebar({ activeView, onViewChange, email, onLogout, onSplits, onCompose, inboxUnread }: Props) {
  return (
